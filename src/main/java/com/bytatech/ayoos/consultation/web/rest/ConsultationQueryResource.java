...
import com.bytatech.ayoos.consultation.service.ConsultationQueryService;
...
public class ConsultationQueryResource {
	 @Autowired
	    ...
	    public ConsultationQueryResource(ConsultationQueryService consultationQueryService) {
		...
		public ResponseEntity<DataResponse> getTasks(@RequestParam(value = "name", required = false) String name,
			...
			return consultationQueryService.getTasks(name, nameLike, description, priority, minimumPriority, maximumPriority,
